...
if (!file.exists("data/games_processed.csv")) {
  print("Running analysis/process_data.R. This will take a couple of minutes but only needs to be done once.")
  source("analysis/process_data.R")
}
...
if (!file.exists("data/guesses_binary_search.csv")) {
  print("Running model/binary_search_model.R. This will take a couple of minutes but only needs to be done once.")
  source("model/binary_search_model.R")
}

if (!file.exists("data/guesses_random_search.csv")) {
  print("Running model/random_search_model.R. This will take a couple of minutes but only needs to be done once.")
