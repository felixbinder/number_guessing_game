...
**TODO*: Ed mentioned he wanted us to look at the distribution of career lengths etc. We have these ploits in the data_summary, but do you think we want to include any of that here/ in the writeup?
...
Overall, around 29.2% of games required more than 7 guesses, and this is a conservative estimate for games completed sub-optimally, as most games would require fewer than 7 guesses using binary search.

**TODO: Again, the simulation would help to make this point more forcefully.**
...
**NOTE: more/better analysis needed here, although tbh we might not want to include this whole section as it is mostly setup/contextualisation to the optimality measures**
...
The number of guesses metric, however, is not very discriminative. Some games will take longer than other even using binary search.

Roughly 1/3 of guesses were exactly optimal.
