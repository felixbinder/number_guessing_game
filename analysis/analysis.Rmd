...
# 2. How optimal are player strategies?

How well do players approximate the optimal strategy (binary search)?

## 2.1. What proportion of users and guesses are optimal?
...
## 2.2. How optimal are other players/guesses?
...
# 4. How do player strategies change over time?

# 4.1. Does player performance improve?
...
```
However, the proportion of optimal guesses markedly increases with the total number of games.
