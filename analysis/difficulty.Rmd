...
- Interval (larger is more difficult; 1A, 2C, 3B)
- Lower Bound (larger is more difficult; 3A)
- Substitution borrowing (borrowing is more difficult; 1D)
- Addition carrying (carrying is more difficult; 1C)
- J is divisible by 10 (no addition needed in the ones place; 3E)


# Marginal effect of attemptNum
