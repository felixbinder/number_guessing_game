...
```{r}
#NOTE TO TEAM: Please double check that I (Rob) did the right thing here to eliminate games with out of bounds guesses. if you think it seems right, feel free to delete this comment
...
write.csv(guesses, "../data/guesses_processed_cj.csv")
